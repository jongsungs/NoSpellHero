    ...
    public void Set (AchievementInfromation Information, AchievementState State)
    {
        ...
        else
        {
            ...
            if (Information.Progression)
            {
                ...
                if (State.Achieved)
                {
                    Percent.text = Information.ProgressGoal + Information.ProgressSuffix + " / " + Information.ProgressGoal + Information.ProgressSuffix + " (달성)";
                }
                else
                {
            ...
            else //Single Time
            {
                ...
                Percent.text = State.Achieved ? "(달성)" : "(잠김)";
            }
        }
    }
