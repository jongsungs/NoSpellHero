...
public class Dragon : Monster
{
    ...
    public SkillBase _fireBress;
    public IObjectPool<SkillBase> _fireBressPool;
    ...
    private void Start()
    {
        ...
        _fireBressPool = new ObjectPool<SkillBase>(CreateFireBress, OngetBress, OnReleaseBress, OnDestroyBress, maxSize: 10);
    ...
    {
        var bone = Instantiate(_fireBress, _skillBarrel.transform.position, transform.rotation, _skillBarrel.transform);
        bone.SetPool(_fireBressPool);
        return bone;
    }
